...
@Component({
  ...
  imports: [
    ...
    StageComponent,
    DisciplineComponent,
    ExperienceComponent,DxTabPanelModule,DxSelectBoxModule,DxTemplateModule,DxTabPanelModule
  ],
...
export class AddEmployeComponent implements OnInit {
  ...
  dataSource: TabPanelItem[] = [
    {
      icon: 'home',  // Icône générique ou autre selon besoin
      title: '',
      tasks: [],
      
    },
    {
      icon: 'fas fa-briefcase',  // Icône de stage
      title: 'Stage',
      tasks: [],
      
    },
    {
      icon: 'fas fa-gavel',  // Icône pour la discipline
      title: 'Discipline',
      tasks: [],
      
    },
    {
      icon: 'fas fa-history',  // Icône pour l'expérience
      title: 'Experience',
      tasks: [],
  ...
  tabsPanelStyle = {
    display: 'flex',
    justifyContent: 'flex-start', // Aligne à gauche, mais peut être ajusté
    marginLeft: '20px', // Ajuste la position des onglets légèrement à droite
  };
  ...
  constructor(private messageService: MessageService, private  EmoloyeService :EmoloyeService, private router: Router, private disciplineService:DisciplineService, private experienceService :ExperienceService) {}
  ...
  ngOnInit() {
    ...
    if (employe.id) {
      ...
      this.getDisciplines(employe.id);
    }
